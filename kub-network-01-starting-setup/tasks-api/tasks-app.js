...
const taskDir = path.join(__dirname, process.env.TASKS_FOLDER);
if (!fs.existsSync(taskDir)) {
  console.log("Create directory:", taskDir);
  fs.mkdirSync(taskDir, { recursive: true });
}
 
const filePath = path.join(taskDir, 'tasks.txt');
// const filePath = path.join(__dirname, process.env.TASKS_FOLDER, 'tasks.txt'); // ori
